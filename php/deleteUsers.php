		...
		<section>
			...
			<div id="moduleDeleteUser" >
				<form action="../Actions/DeleteUsers.php" method="post">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><?php 
											if($row['bType']<>0){
												echo "<input type='checkbox' name='checkboxDeleteUser[]' value= '".$row["vcRFC"]."'>";
											}
												?></td>
								</tr>
							<?php
					...
					<input type="submit" name="buttonDeleteUsers" value="Eliminar Usuarios Seleccionados"/>
					<input type="reset" name="buttonResetDeleteUsers" vaule="Limpiar Selección"/>
				</form>
			</div>
