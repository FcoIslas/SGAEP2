function generateSubjectID(){
	...
	//replace forbidden symbols on Subject Name
	//generateID for DB
	var inputFirstLetter = document.getElementById("inputAddSubjectName");
	var firstLetter = inputFirstLetter.value;
	var val = firstLetter.replace(/\s/g, '');
	val2 = removeDiacritics(val);
	var inputSubjectNameID = document.getElementById("inputSubjectNameID");
	inputSubjectNameID.value = val2;
	//generate ID for DB
}
...
function removeDiacritics(str) {
  ...
  return str;
	...
	//from https://stackoverflow.com/users/318752/jeroen
